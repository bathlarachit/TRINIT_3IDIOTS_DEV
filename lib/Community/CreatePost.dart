...
class CreatePost extends StatefulWidget {
  String domain="";
   CreatePost(String domain, {super.key}){
    this.domain=domain;
  }
                            ...
                            SizedBox(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  contentPadding: const EdgeInsets.only(
                                      left: 25, top: 10, bottom: 10, right: 20),
                                  labelText: 'Enter event photo url',
                                  border: InputBorder.none,
                                  filled: true,
                                  fillColor: const Color(0xFFd8f2fd),
                                  focusedBorder: OutlineInputBorder(
                                    ...
                                    ? SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            await db.ref("CommunityPosts/${widget.domain}/$z/").set({
                                              "mssg":caption,
                                              "photoLink":plink,
                                              "createdBy":Staticfile.name
                                            });
                                            setState(() {
                                              load1=false;
                                              caption="";
